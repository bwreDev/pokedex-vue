...
export interface ChainModel {
  ...
  name: string;
  imagen: string;
  next_evolution?: ChainModel | null;
}

export interface PokemonSpeciesFormat {
  color: string;
  habitat: string;
  is_legendary: boolean;
  generation: string;
...
export interface PokemonPokedex {
  ...
  base_experience: number;
  types: string[];
  stats: { name: string; base_start: number }[];
  species: PokemonSpeciesFormat;
  evolution_chain: ChainModel | null;
  imagen: string;
}

export interface PlainEvolutionChain {
  id: number;
  name: string;
  imagen: string;
}
